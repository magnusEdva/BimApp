    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (uri.getPath()) {
            ...
            case ("/" + TOPIC_TABLE):
                ...
                else if(selectionArgs != null && selectionArgs[0].equals(OPEN))
                    cursor = database.topicDao().getOpenTopics(selection, "Closed");
                else if (selectionArgs != null && selectionArgs[0].equals(GUID))
                    cursor = database.topicDao().getTopicFromId(selection);
                else
